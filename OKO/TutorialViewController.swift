...
class TutorialViewController: UIViewController, UIScrollViewDelegate {
    ...
    let texts :[String] = ["Новое бесплатное приложение для обнаржуения различных дорожных опасностей.", "Для запуска достаточно коснуться кнопки включения, затем поместить смартфон под лобовое стекло в горизонтальном положении.", "Убрав отметку в фильтре дорожных знаков, Вы отключаете оповещения о данном типе знаков, но на карте они будут показаны.", "Пользователи сами формируют и обновляют общую базу данных, добавляя новую информацию об обнаруженных объектах."]
